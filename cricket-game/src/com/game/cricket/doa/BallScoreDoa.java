    ...
    public void addBowlingScores(Match match){
        try {
            ...
            for(int i=0;i<match.getTeam1().getPlayers().size();++i){
                ...
                pstmt.setInt(2,player.getScore().getWickets());
                pstmt.setInt(3,player.getScore().getDotBalls());
                pstmt.setInt(4,player.getScore().getOneRunBalls());
                pstmt.setInt(5,player.getScore().getTwoRunBalls());
                pstmt.setInt(6,player.getScore().getThreeRunBalls());
                pstmt.setInt(7,player.getScore().getFourRunBalls());
                pstmt.setInt(8,player.getScore().getSixRunBalls());
                pstmt.setInt(9,player.getScore().getCurrBall());
                pstmt.execute();
            }
